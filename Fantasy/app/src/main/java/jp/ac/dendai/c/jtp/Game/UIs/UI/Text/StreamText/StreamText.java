...
public class StreamText implements UI{
    ...
    public boolean isEnd(){
        return char_y >= string.length && char_x >= string[string.length-1].length();
    }
    ...
    public static StreamText createStreamText(String text,Bitmap mask,int size,int color){
        return createStreamText(text,mask,size,Color.red(color),Color.green(color),Color.blue(color));
    }
